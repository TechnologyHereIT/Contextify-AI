...
# ==============================================================================
# 1. UI CONFIGURATION & PAGE SETUP (Contextify AI)
# ==============================================================================
st.set_page_config(
...
# Custom CSS for Three-Panel Layout and Modern Styling
st.markdown("""
<style>
    .main-header {
        font-size: 2.3rem;
...
# ==============================================================================
# 2. INITIALIZE SESSION STATE & SIDEBAR PANEL (PANEL 1)
# ==============================================================================
if "messages" not in st.session_state:
    st.session_state.messages = []
if "current_pdf_base64" not in st.session_state:
...
# Dynamic Connection Indicator Logic
if api_key:
...
uploaded_files = st.sidebar.file_uploader(
    "Upload research contexts (PDF, TXT, MD):",
        ...
        with tab_mindmap:
            if st.button("🚀 Structuralize Context into Mindmap"):
                with st.spinner("Agent is architecturalizing the interactive graph schema..."):
                    try:
                        mindmap_prompt = f"""
                        Analyze the following research context and create a highly structured conceptual mindmap using Mermaid.js syntax.
                        ...
                        if response.status_code == 200:
                            ...
                            # Clean string operation split carefully to completely prevent syntax errors
                            clean_code = raw_code.replace("```mermaid", "")
            ...
            if st.session_state.mindmap_code:
                ...
                # HTML injection for flawless Mermaid deployment inside any browser container
                html_code = f"""
...
# ==============================================================================
# 4. RIGHT PANEL: INTELLIGENT RAG ASSISTANT CHAT
# ==============================================================================
with right_panel:
    ...
    if prompt := st.chat_input("Query summaries, specific formulas, or validation data..."):
        ...
        You are a professional Agentic Research Assistant operating under the Contextify AI core. Your strict objective is to answer the user's questions accurately 
        based ONLY on the context of the uploaded documents provided below.
...
# ==============================================================================
# 5. SIDEBAR INFORMATION EXPANDERS
# ==============================================================================
with st.sidebar.expander("📖 How to Use"):
    st.markdown("""
    **Step 1:** Upload your documents (PDF, TXT, or MD)
